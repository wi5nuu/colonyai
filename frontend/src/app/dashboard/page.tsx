          ...
          <div key={i} className="bg-white border border-slate-200 p-5 rounded-lg shadow-sm group hover:border-primary/30 transition-all">
            <div className="flex justify-between items-start mb-4">
              <div className="p-2 bg-slate-50 rounded-md group-hover:bg-primary/5 transition-colors">
                <card.icon className="w-4 h-4 text-slate-400 group-hover:text-primary" />
              </div>
              <span className={`text-[10px] font-black ${card.trend.includes('+') ? 'text-emerald-500' : 'text-slate-400'} uppercase tracking-tighter`}>{card.trend}</span>
            </div>
            <div>
              <p className="text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] mb-1">{card.label}</p>
          ...
          <div className="dashboard-card rounded-lg">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-3">
                 ...
                 <button className="p-2 bg-slate-50 rounded-md border border-slate-200">
