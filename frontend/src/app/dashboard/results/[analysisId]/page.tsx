...
export default function ResultsPage() {
  ...
  const documentationText = `COLONYAI AUDIT RESULTS INTERPRETATION
====================================

1. NEURAL MAPPING LAYER
This layer shows the visualization of biological object detection. Use the 'Annotations' toggle to view the Bounding Boxes generated by AI.

2. SPECTRAL DISTRIBUTION
- Verified: Colonies recognized as colony-forming units (CFU).
- Filtered: Artifacts (bubbles, dust, cracks) rejected by the neural system to prevent False Positives.

3. ISO-17025 COMPLIANCE (GUM METRICS)
- Uncertainty (U): Uncertainty value calculated based on the GUM (Guide to the Expression of Uncertainty in Measurement) protocol.
- Confidence Score: Confidence level of the AI model for all detections on this specimen.

4. FINAL VERIFICATION
Manager or Admin must press the 'Verify Audit' button after reviewing detection accuracy to legitimize the official report.

STATUS: AUDIT PENDING VERIFICATION
ENGINE: YOLOv8 SENSITIVE NODE`;
      ...
      <div className="flex relative min-h-[calc(100vh-200px)]">
        ...
        <div className="hidden lg:block">
          <DocumentationSidebar
            ...
            description="Technical audit guide for neural detection validation and ISO-17025 compliance."
