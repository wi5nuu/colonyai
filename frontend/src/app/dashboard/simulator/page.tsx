                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2">
                  {(
                    ...
                    >
                      ...
                      />
                      <p className="text-[8px] font-bold text-slate-900 uppercase tracking-wider leading-tight truncate">
                        {t(cfg.label)}
                      </p>
                    </button>
                  ))}
              ...
              <div className="lg:col-span-6 space-y-6">
                <div className="bg-white border border-slate-200/60 p-4 rounded-xl shadow-sm">
                  <div className="flex items-center justify-between mb-4 border-b border-slate-50 pb-2">
                    <h3 className="text-[9px] font-bold text-slate-900 uppercase tracking-[0.2em]">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="space-y-0.5">
                      <p className="text-[9px] font-bold text-slate-900 uppercase tracking-[0.2em]">
                        {t("simulator.total")}
                      </p>
                      <input
                        type="number"
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-slate-100 hover:bg-slate-200 text-slate-900 rounded-lg text-[9px] font-bold uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2"
                  >
