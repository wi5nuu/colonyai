    ...
    <div className="animate-in fade-in duration-500 w-full pb-12 px-0 sm:px-2">
      ...
      <div className="mb-4">
        <button 
          ...
          className="flex items-center gap-2 text-[10px] font-bold text-slate-400 hover:text-slate-900 uppercase tracking-widest transition-colors mb-3 group"
        >
        ...
        <div className="flex items-center gap-3 mb-2">
          <div>
            <h1 className="text-xl font-bold text-slate-900 uppercase tracking-tight leading-none">Provision Node</h1>
            <p className="text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-1">Tenant Onboarding System</p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleProvision} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 items-start">
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-bold text-slate-900 focus:ring-1 focus:ring-primary/20 outline-none transition-all placeholder:text-slate-300"
                    />
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">Matrix</label>
                      <select 
                        value={newOrgData.institution_type}
                        onChange={(e) => setNewOrgData({...newOrgData, institution_type: e.target.value})}
                        className="w-full px-2 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-bold text-slate-900 focus:ring-1 focus:ring-primary/20 outline-none"
                      >
                    ...
                    <div className="space-y-1">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">Standard</label>
                      <select 
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-bold text-slate-900 focus:ring-1 focus:ring-amber-500/20 outline-none transition-all"
                    />
                  </div>
                  <div className="space-y-1">
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    <div className="flex items-center justify-between ml-1">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Node Allocation</label>
                    ...
                    <select 
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-bold text-slate-900 focus:ring-1 focus:ring-blue-500/20 outline-none"
                    >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">S3 Quota</label>
                      <select 
                        value={newOrgData.storage_quota}
                        onChange={(e) => setNewOrgData({...newOrgData, storage_quota: e.target.value})}
                        className="w-full px-2 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-bold text-slate-900"
                      >
                    ...
                    <div className="space-y-1">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">Retention</label>
                      <select 
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">BSL Level</label>
                      <select 
                      ...
                      <p className="text-[7px] text-slate-400 font-bold ml-1 uppercase">Bio-Safety Standard</p>
                    </div>
                    <div className="space-y-1">
                      <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">Audit Cycle</label>
                      <select 
                      ...
                      <p className="text-[7px] text-slate-400 font-bold ml-1 uppercase">Compliance Frequency</p>
                    </div>
                  </div>
                  <div className="space-y-1">
                    <label className="text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1">Network Whitelist</label>
                    <input 
                      type="text" 
            ...
            <div className="xl:col-span-1 space-y-4">
              <div className="bg-slate-900 rounded-xl p-5 shadow-xl text-white">
                ...
                <div className="space-y-4">
                  ...
                  <label className="flex items-start gap-3 p-3 bg-white/5 border border-white/10 rounded-lg cursor-pointer group hover:bg-white/10 transition-all">
                  ...
                  <button 
                    ...
                    className="w-full py-3 bg-primary text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-lg shadow-lg hover:bg-primary/90 active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isProvisioning ? (
              ...
              <div className="hidden xl:block bg-slate-50 border border-slate-200 rounded-xl p-5">
        ...
        <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500 max-w-4xl mx-auto py-8">
          <div className="bg-white border border-slate-200 rounded-[32px] p-8 sm:p-12 text-center shadow-xl shadow-slate-200/50 relative overflow-hidden">
            ...
            <p className="text-sm text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
              Infrastruktur untuk <span className="text-slate-900 font-bold">{provisionResult.organization_name || newOrgData.name}</span> telah berhasil di-deploy pada node Jakarta.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm transition-all hover:border-primary/30 group">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <Key className="w-4 h-4 text-primary" />
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">License Key</span>
                </div>
                <button 
                  type="button"
                  onClick={() => {
                  ...
                  className="px-3 py-1 bg-slate-50 hover:bg-slate-100 text-[10px] font-bold text-slate-600 rounded-lg transition-all"
                >
                  Copy
                </button>
              </div>
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-sm transition-all hover:border-amber-300 group">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <Lock className="w-4 h-4 text-amber-500" />
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Admin Credentials</span>
                </div>
                <button 
                  type="button"
                  onClick={() => {
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button 
              ...
              className="w-full sm:w-auto px-10 py-4 bg-white border border-slate-200 text-slate-900 text-[11px] font-bold uppercase tracking-widest rounded-2xl hover:bg-slate-50 transition-all active:scale-95 shadow-sm"
            >
              Provision Another Node
            </button>
            <button 
              onClick={() => router.push("/dashboard/super")}
              className="w-full sm:w-auto px-12 py-4 bg-slate-900 text-white text-[11px] font-bold uppercase tracking-widest rounded-2xl hover:bg-slate-800 transition-all active:scale-95 shadow-lg shadow-slate-900/20"
            >
              Return to Nexus
            </button>
          </div>
