               ...
               <div className="space-y-8">
                  {!isSent ? (
                    <>
                      <div className="text-center">
                         ...
                         <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mt-1">Industrial Access Recovery</p>
                      </div>

                      <form onSubmit={handleSubmit} className="space-y-6">
                         <div className="space-y-4">
                            <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed font-bold uppercase tracking-wider text-center">
                               {t("auth.forgotSubtitle") || "Enter your registered email to receive a secure recovery link."}
                            </p>
                            <div className="space-y-2">
                               <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Registered Email</label>
                         ...
                         <div className="space-y-4">
                            <button 
                               type="submit" 
                               disabled={isLoading}
                               className="w-full h-14 bg-[#0055ff] text-white text-[11px] font-black uppercase tracking-[0.2em] hover:bg-[#0055ff]/80 transition-all flex items-center justify-center gap-3 shadow-xl shadow-blue-900/10"
                            >
                               {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <>Send Recovery Link <Lock className="w-4 h-4" /></>}
                            </button>
                            <Link 
                               href="/login" 
                               className="flex items-center justify-center gap-2 text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest hover:text-[#0055ff] dark:hover:text-[#00f2ff] transition-colors"
                            >
                    ...
                    <div className="text-center space-y-8 animate-in fade-in zoom-in-95 duration-500">
                       ...
                       <div className="space-y-3">
                          ...
                          <p className="text-[11px] text-slate-500 dark:text-slate-400 font-bold uppercase leading-relaxed tracking-wider">
                             ...
                             <span className="text-[#0055ff] dark:text-[#00f2ff]">{email}</span>
                          </p>
                       </div>
                       <div className="p-5 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 space-y-4">
                          ...
                          <Link 
                             href="/reset-password" 
                             className="w-full h-12 bg-[#0055ff] text-white text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#0055ff]/80 transition-colors shadow-lg"
                          >
                             Enter Verification Token <Key className="w-4 h-4" />
                          </Link>
                          <Link 
                             href="/login" 
                             className="w-full h-12 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-400 dark:text-slate-500 text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors"
                          >
                  ...
                  <div className="pt-8 border-t border-slate-100 dark:border-slate-900 space-y-4">
                     <div className="flex items-center gap-2 px-3 py-1 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/35 w-fit mx-auto">
                        ...
                        <span className="text-[9px] font-black text-emerald-600 dark:text-emerald-450 uppercase tracking-widest">Authorized Identity Recovery</span>
                     </div>
