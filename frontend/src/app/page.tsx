          ...
          <div className="md:hidden border-t border-border bg-background">
            <div className="px-4 py-3 space-y-2">
              ...
              <div className="pt-2 border-t border-border flex gap-2">
                <Link
                  href="/login"
                  className="flex-1 text-center text-sm font-medium text-muted-foreground hover:text-foreground py-2"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Login
                </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-base sm:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Transform agar plate images into accurate CFU/ml reports in under
              2 minutes. Eliminating the 22.7%-80% variability of manual
              counting for 500+ Indonesian labs.
            </p>
              ...
              <div className="p-6 sm:p-8">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="bg-muted/20 rounded-xl border border-border p-4 aspect-square flex items-center justify-center relative overflow-hidden">
                    ...
                    <div
                      className="absolute inset-0 bg-gradient-to-b from-transparent via-primary/10 to-transparent animate-pulse"
                      style={{ top: "-100%", animationDuration: "3s" }}
                    />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">
              Manual Colony Counting is Broken
            </h2>
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              Total Plate Count (TPC) remains the gold standard, but manual
              processing creates significant operational risks.
            </p>
          </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">
              Who Benefits from ColonyAI?
            </h2>
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              Serving 500+ accredited microbiology testing facilities across
              Indonesia.
            </p>
          </div>
      ...
      <section id="solution" className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              ColonyAI combines AI vision, intelligent dashboard, and reporting
              into one platform.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
      ...
      <section className="py-12 sm:py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">
              Precise Artifact Rejection
            </h2>
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              Our model classifies all objects into 5 distinct categories with
              &gt;90% precision.
            </p>
          </div>
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-3 h-3 rounded-full ${cls.color} flex-shrink-0`}
                    />
      ...
      <section className="py-12 sm:py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-3">
              How ColonyAI Compares
            </h2>
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              See why ColonyAI outperforms manual counting and expensive
              alternatives.
            </p>
          </div>
          <div className="bg-card rounded-xl border border-border overflow-hidden">
                  ...
                  {competitiveComparison.slice(0, 7).map((row, i) => (
                    ...
                    >
                      ...
                      <td className="text-center px-4 py-3 hidden md:table-cell">
                        {row.sphereflash === true ? (
                          <Check className="h-4 w-4 text-green-500 mx-auto" />
                        ) : row.sphereflash === false ? (
                          <X className="h-4 w-4 text-red-500 mx-auto" />
                        ) : (
                          <span className="text-xs text-amber-500">
                            {row.sphereflash}
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              Built for ISO 17025 accredited laboratories with full audit trail
              compliance.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <ul className="space-y-1">
                  {sprint.items.map((item, ii) => (
                    <li key={ii} className="text-xs text-muted-foreground">
                      • {item}
                    </li>
                  ))}
                </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-muted-foreground">
              President University — Bachelor of Information Technology
            </p>
          </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join the AI-powered revolution in microbiological testing. Reduce
            analysis time by 85-90% and eliminate manual counting errors.
          </p>
          <div className="flex gap-3 justify-center">
            ...
            <a
              href="mailto:wisnu.ashar@student.president.ac.id"
              className="btn-secondary flex items-center justify-center gap-2 flex-1 sm:flex-none"
            >
      ...
      <footer className="py-12 border-t border-border bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-xs text-muted-foreground mb-4">
                AI-powered automated plate count reader for microbiology
                laboratories.
              </p>
          ...
          <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground">
              © 2026 ColonyAI — President University. Built for AI Open
