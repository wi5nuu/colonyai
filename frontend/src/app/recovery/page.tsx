        ...
        <div className="text-center space-y-6">
          <div className="inline-flex flex-col items-center gap-4">
            ...
            <div className="space-y-1">
              <h2 className="text-3xl font-black text-white tracking-tighter uppercase leading-none">Security Recovery</h2>
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]">Access Restoration Protocol</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#12141c]/80 backdrop-blur-xl border border-white/5 p-8 sm:p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
          ...
          {!isSent ? (
              ...
              <div className="space-y-4">
                ...
                >
                  {isLoading ? (
                    ...
                    <><Lock className="w-5 h-5" /> Request Reset Token</>
                  )}
                </button>
            ...
            <div className="text-center space-y-8 py-4">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-bold text-white">Permintaan Terkirim</h3>
                <p className="text-xs text-slate-400 leading-relaxed font-medium">
                  Jika email <strong>{email}</strong> terdaftar di sistem kami, Anda akan segera menerima instruksi pemulihan.
                </p>
              </div>
