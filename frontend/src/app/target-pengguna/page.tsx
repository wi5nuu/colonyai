      ...
      <section className="py-12 lg:py-16 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl space-y-4 text-left">
            ...
            <p className="text-xs lg:text-sm text-slate-500 font-bold leading-relaxed max-w-xl uppercase tracking-wide">
      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-4">
            <h2 className="text-2xl lg:text-4xl font-bold text-slate-900 uppercase tracking-tight">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <div
                key={i}
                className={`bg-white rounded-xl p-10 border-b-4 ${persona.accent} shadow-xl hover:-translate-y-2 transition-all duration-500 group h-full flex flex-col`}
              >
                <div
