      ...
      <section className="py-20 bg-slate-50 border-b border-slate-100 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center space-y-6">
           <div className="inline-flex items-center gap-3 px-4 py-2 bg-white border border-slate-200 rounded-xl shadow-sm">
             ...
             <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Governance & Terms</span>
           </div>
           <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-slate-900 uppercase">
             Syarat & <span className="text-[#0055ff]">Ketentuan</span>
           </h1>
           <p className="text-slate-500 font-medium uppercase tracking-widest text-xs">
             Versi 1.0.26 - Efektif 02 Mei 2026
           </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-white border border-slate-100 rounded-3xl p-8 lg:p-16 shadow-2xl space-y-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-600 leading-relaxed text-sm font-medium">
              Setiap analis dan organisasi bertanggung jawab penuh atas:
            </p>
            <div className="grid md:grid-cols-2 gap-4">
               <div className="p-5 bg-slate-50 border border-slate-100 rounded-xl space-y-2">
                  <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Validasi Hasil</h4>
                  <p className="text-[11px] text-slate-500 font-bold leading-relaxed uppercase">Melakukan verifikasi manual terhadap deteksi AI sebelum finalisasi data.</p>
               </div>
               <div className="p-5 bg-slate-50 border border-slate-100 rounded-xl space-y-2">
                  <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-widest">Keamanan Akun</h4>
                  <p className="text-[11px] text-slate-500 font-bold leading-relaxed uppercase">Menjaga kerahasiaan kredensial login sesuai protokol zero-trust.</p>
               </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 rounded-2xl p-8 lg:p-12 text-center space-y-8 relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
              ...
              >
                <Phone className="w-4 h-4" /> Start a Call / Inquiry
              </Link>
            </div>
          </div>
