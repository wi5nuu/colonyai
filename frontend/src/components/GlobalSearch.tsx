...
const MOCK_DATABASE: SearchItem[] = [
  {
    ...
    titleID: "Piringan Agar Escherichia coli #12",
    detailsEN: "YOLOv8 Detection: 142 Colonies | Accuracy: 94.2% | Lab Node: Jakarta Central",
    detailsID: "Deteksi YOLOv8: 142 Koloni | Akurasi: 94.2% | Node Lab: Jakarta Pusat",
    statusEN: "Verified",
    statusID: "Terverifikasi",
    date: "2026-05-18",
  },
  {
    id: "SPEC-0741-B",
    ...
    titleID: "Cawan Petri Staphylococcus aureus #03",
    detailsEN: "YOLOv8 Detection: 87 Colonies | Accuracy: 93.1% | Lab Node: Bandung BioTech",
    detailsID: "Deteksi YOLOv8: 87 Koloni | Akurasi: 93.1% | Node Lab: Bandung BioTech",
    statusEN: "Pending Validation",
    statusID: "Menunggu Validasi",
    date: "2026-05-17",
  },
  {
    id: "SPEC-1109-C",
    ...
    titleID: "Piringan Agar Salmonella enterica #44",
    detailsEN: "YOLOv8 Detection: 312 Colonies | Accuracy: 95.8% | Lab Node: Surabaya BioSafety",
    detailsID: "Deteksi YOLOv8: 312 Koloni | Akurasi: 95.8% | Node Lab: Surabaya BioSafety",
    statusEN: "Verified",
    statusID: "Terverifikasi",
    date: "2026-05-18",
  },
  {
    ...
    titleID: "Lab Mikrobiologi Jakarta Pusat",
    detailsEN: "Active Nodes: 12 Petri Readers | Lead Analyst: Dr. H. Wibowo | Accreditation: ISO-17025",
    detailsID: "Node Aktif: 12 Pembaca Petri | Analis Utama: Dr. H. Wibowo | Akreditasi: ISO-17025",
    statusEN: "Operational",
    statusID: "Operasional",
    date: "Active",
  },
  {
    id: "NODE-BDG-02",
    ...
    titleID: "Node Penelitian BioTek Bandung",
    detailsEN: "Active Nodes: 8 Petri Readers | Lead Analyst: Prof. S. Santoso | Accreditation: ISO-17025",
    detailsID: "Node Aktif: 8 Pembaca Petri | Analis Utama: Prof. S. Santoso | Akreditasi: ISO-17025",
    statusEN: "Operational",
    statusID: "Operasional",
    date: "Active",
  },
  {
    ...
    titleID: "Pusat BioSafety Surabaya",
    detailsEN: "Active Nodes: 15 Petri Readers | Lead Analyst: Dr. R. Amelia | Accreditation: ISO-17025",
    detailsID: "Node Aktif: 15 Pembaca Petri | Analis Utama: Dr. R. Amelia | Akreditasi: ISO-17025",
    statusEN: "Operational",
    statusID: "Operasional",
    date: "Active",
  }
