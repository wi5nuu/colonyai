...
for cls_id, count in sorted(class_counts.items()):
    ...
    status = 'OK' if count > 100 else 'WARNING' if count > 50 else 'LOW'
...
if max_count > min_count * 5:
    print('WARNING: Imbalance terdeteksi! Kelas minoritas perlu augmentasi.')
else:
    print('OK: Distribusi kelas cukup seimbang untuk training.')
print('='*60)
