...
print("Memuat mesin PyTorch dan Ultralytics (Mohon tunggu beberapa detik)...")
...
DATASET_YAML = os.path.join(os.path.dirname(__file__), "datasets", "colony_dataset", "data.yaml")
...
IMG_SIZE = 640           # Lower resolution to prevent OOM
BATCH = 4                # Lower batch size to prevent OOM
...
def main():
    ...
    # ⚠️ Mengurangi ukuran gambar dan batch agar tidak OOM (Out of Memory) di RTX 5050 8GB
    EPOCHS = 80
    IMG_SIZE = 640
    BATCH = 4
